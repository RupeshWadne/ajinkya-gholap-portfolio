      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
        ...
        <div className="space-y-10">
          ...
          <div className="flex flex-col sm:flex-row gap-6 pt-6">
            <a href={`mailto:${PERSONAL_INFO.email}`} className="flex items-center justify-center space-x-4 bg-orange-600 dark:bg-orange-600 text-white px-10 py-5 rounded-full text-lg font-black hover:bg-gray-900 dark:hover:bg-white dark:hover:text-gray-900 transition-all group shadow-xl hover:shadow-orange-200 dark:hover:shadow-orange-900/40">
