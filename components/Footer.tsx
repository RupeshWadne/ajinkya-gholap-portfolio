          ...
          <div className="lg:col-span-7 flex flex-col items-end">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 gap-16 mt-24 w-full">
              ...
              <div className="space-y-6">
                ...
                <ul className="space-y-3 text-lg font-medium opacity-70">
                  <li><a href={PERSONAL_INFO.github} className="hover:text-orange-600 transition-colors">GitHub Repository</a></li>
                  <li><a href={PERSONAL_INFO.linkedin} className="hover:text-orange-600 transition-colors">LinkedIn Profile</a></li>
                </ul>
              </div>
              <div className="space-y-6">
                <p className="text-xs font-black uppercase tracking-[0.3em] text-orange-600">Connect</p>
                <div className="flex space-x-5">
                  <a href={PERSONAL_INFO.linkedin} className="w-12 h-12 flex items-center justify-center bg-white/5 rounded-2xl hover:bg-orange-600 transition-all border border-white/10"><Linkedin size={20}/></a>
                  <a href={PERSONAL_INFO.github} className="w-12 h-12 flex items-center justify-center bg-white/5 rounded-2xl hover:bg-orange-600 transition-all border border-white/10"><Github size={20}/></a>
                  <a href="#" className="w-12 h-12 flex items-center justify-center bg-white/5 rounded-2xl hover:bg-orange-600 transition-all border border-white/10"><Instagram size={20}/></a>
                </div>
              </div>
            </div>
          </div>
